/**
 * Package-owned invariant companion for `dsh-request-flight-recorder`.
 * @module dsh-request-flight-recorder/invariant
 */
...
export const name = 'request-flight-recorder-invariant'
